...
run_all_tests() {
    ...
    local structure_methods=(
        ...
        "get_available_versions:{\"app_id\":\"ollama\"}"
        "get_installed_versions:{\"app_id\":\"ollama\"}"
        "get_active_version:{\"app_id\":\"ollama\"}"
        "get_default_version:{\"app_id\":\"ollama\"}"
        "is_ollama_running:{}"
        "has_background_fetch_completed:{}"
        "get_github_cache_status:{\"app_id\":\"ollama\"}"
        "get_library_status:{}"
        "get_network_status:{}"
    )
